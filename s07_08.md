...
```
Us [sona](https://jdelgadopin.github.io/CAP2024-25/s05_06.html#35)?...
...
poc costós afegir elements al davant de la llista amb `cons`). Una conté part de la cua, i l'altra 
conté el que resta de la cua, però invertit.
...
`empty?`, `equal`), que implementi una cua d'aquesta manera, fent servir _closures_ i _pipelining_
