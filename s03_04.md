...
El gran avantatge és que explotar la possibilitat de fer servir funcions d'ordre
superior ens permet major expressivitat i per tant escriure codi més compacte.
...
Si tenim funcions d'ordre superior podem implementar estructures de dades. Perdem en eficiència, però aquest és un
exercici, un cop més, en expressivitat.
...
claus per recuperar els valors associats.

Operacions que volem sobre aquesta estructura: `crear`/`cercar`/`afegir`. 

Podem construir una estructura amb aquestes característiques fent servir
_només_ funcions? És més senzill del que ens pensem...
